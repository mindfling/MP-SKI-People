        ...
        <div class="swiper product__slider-main">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img class="product__slider-image" src="/img/ski1.png" />
            </div>

            <div class="swiper-slide">
              <img class="product__slider-image" src="/img/ski2.png" />
            </div>

            <div class="swiper-slide">
              <img class="product__slider-image" src="/img/ski3.png" />
            </div>
            
            <div class="swiper-slide">
              <img class="product__slider-image" src="/img/ski4.png" />
            </div>
          </div>

          <button type="button" class="swiper-button-prev product__slider-arrow product__slider-arrow_prev">
            <!-- PREV -->
          ...
          <button type="button" class="swiper-button-next product__slider-arrow product__slider-arrow_next">
            <!-- NEXT -->
            <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div thumbsSlider="" class="swiper product__slider-thumbnails slider-thumbnails">
          <div class="swiper-wrapper">
            <div class="swiper-slide slider-thumbnails__item">
              <img class="slider-thumbnails__image" src="/img/ski9.png" />
            </div>

            <div class="swiper-slide slider-thumbnails__item">
              <img class="slider-thumbnails__image" src="/img/ski10.png" />
            </div>
            
            <div class="swiper-slide slider-thumbnails__item">
              <img class="slider-thumbnails__image" src="${LOCAL}/img/ski4.png" />
            </div>

            <div class="swiper-slide slider-thumbnails__item">
              <img class="slider-thumbnails__image" src="${LOCAL}/img/ski5.png" />
            </div>
          </div>
        </div>
